      ...
      <div className="w-full max-w-3xl space-y-6 my-auto">
        ...
        >
          <button
            ...
            className="text-sm font-mono text-terminal-muted hover:text-terminal-dark transition-colors disabled:opacity-50"
          >
            {t("back")}
          </button>
          ...
          <button
            onClick={onConfirm}
            disabled={isSubmitting}
            className="px-6 py-2 bg-terminal-green text-terminal-dark font-mono text-sm font-bold rounded hover:bg-terminal-green/90 transition-colors disabled:opacity-50"
          >
