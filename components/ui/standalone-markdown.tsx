  ...
  return (
    <div className={className}>
      <ReactMarkdown
        ...
        h1: ({ children, ...props }) => (
          <h1 className="text-2xl font-bold font-mono mt-6 mb-3 text-terminal-dark" {...props}>
            {children}
          </h1>
        ),
        h2: ({ children, ...props }) => (
          <h2 className="text-xl font-bold font-mono mt-5 mb-2 text-terminal-dark" {...props}>
            {children}
          </h2>
        ),
        h3: ({ children, ...props }) => (
          <h3 className="text-lg font-semibold font-mono mt-4 mb-2 text-terminal-dark" {...props}>
            {children}
          </h3>
        ),
        h4: ({ children, ...props }) => (
